...
#    if defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_CROSS) || defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTICROSS)

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_CROSS
RGB_MATRIX_EFFECT(SOLID_REACTIVE_CROSS)
#        endif

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTICROSS
...
#    endif     // !defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_CROSS) || defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTICROSS)
