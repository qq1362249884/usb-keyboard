...
#    if defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_NEXUS) || defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTINEXUS)

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_NEXUS
RGB_MATRIX_EFFECT(SOLID_REACTIVE_NEXUS)
#        endif

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTINEXUS
...
#    endif     // !defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_NEXUS) || !defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTINEXUS)
