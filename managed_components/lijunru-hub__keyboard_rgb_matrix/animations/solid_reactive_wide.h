...
#    if defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_WIDE) || defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTIWIDE)

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_WIDE
RGB_MATRIX_EFFECT(SOLID_REACTIVE_WIDE)
#        endif

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTIWIDE
...
#    endif     // !defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_WIDE) || !defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTIWIDE)
