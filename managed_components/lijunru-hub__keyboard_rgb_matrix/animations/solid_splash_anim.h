...
#    if defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_SPLASH) || defined(CONFIG_ENABLE_RGB_MATRIX_SOLID_MULTISPLASH)

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_SPLASH
RGB_MATRIX_EFFECT(SOLID_SPLASH)
#        endif

#        ifdef CONFIG_ENABLE_RGB_MATRIX_SOLID_MULTISPLASH
